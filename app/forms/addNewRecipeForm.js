...
const allowedPortionSizes = ['1', '2', '3', '4', '5', '6', '7', '8']
	...
	return (
		<Formik
			...
			initialTouched={{
				recipeName: false,
				recipeLink: false,
				recipePortionSize: false
			}}
			onSubmit={values =>
				onSubmit(values.recipeName, values.recipeLink, values.recipePortionSize)
			}
			...
			{({
				...
				return (
					<>
						...
						<Spacer spaceRequired={3} />
						<TextInput
							accessibilityLabel="link to recipe input"
							onChangeText={val => {
								const formattedVal = val.charAt(0).toUpperCase() + val.slice(1)
